...
public class Globals {
  public static val colors as Color[ColorName] = {
    ...
    ColorName.None: new Color(ColorName.None, "Бесцветный", "none", 9539985), // #919191
    ColorName.Red: new Color(ColorName.Red, "Красный", "red", 11546150), // #b02e26
    ColorName.Green: new Color(ColorName.Green, "Зелёный", "green", 6192150), // #5d7c15
    ColorName.Lime: new Color(ColorName.Lime, "Лаймовый", "lime", 8439583), // #80c71f
    // ColorName.Blue: new Color(ColorName.Blue, "Blue", "blue", 33023), // #0080ff
    ColorName.Blue: new Color(ColorName.Blue, "Синий", "blue", 3949738), // #3c44a9
    ColorName.LightBlue: new Color(ColorName.LightBlue, "Голубой", "light_blue", 3847130), // #3ab3da
    ColorName.Gray: new Color(ColorName.Gray, "Серый", "gray", 4673362), // #474f52
    ColorName.LightGray: new Color(ColorName.LightGray, "Светло-серый", "light_gray", 10329495), // #9c9d97
    ColorName.Yellow: new Color(ColorName.Yellow, "Жёлтый", "yellow", 16701501), // #ffd83d
    // ColorName.Purple: new Color(ColorName.Purple, "Purple", "purple", 8388736), // #800080
    ColorName.Purple: new Color(ColorName.Purple, "Фиолетовый", "purple", 8991416), // #8932b7
    ColorName.Magenta: new Color(ColorName.Magenta, "Пурпурный", "magenta", 13061821), // #c64fbd
    ColorName.Pink: new Color(ColorName.Pink, "Розовый", "pink", 15961002), // #f38caa
    ColorName.White: new Color(ColorName.White, "Белый", "white", 16383998), // #f9ffff
    ColorName.Black: new Color(ColorName.Black, "Чёрный", "black", 1908001), // #1d1c21
    ColorName.Brown: new Color(ColorName.Brown, "Коричневый", "brown", 8606770), // #825432
    ColorName.LightBrown: new Color(ColorName.LightBrown, "Коричневый", "brown", 9849600), // #964B00
    ColorName.Cyan: new Color(ColorName.Cyan, "Бирюзовый", "cyan", 1481884), // #169c9d
    ColorName.Orange: new Color(ColorName.Orange, "Оранжевый", "orange", 16351261), // #f9801d
