...
new Food(1, 0.25, false, true)
    ...
    .register();
new Food(1, 1, false, true, player => player.sendMessage("Фу"))
...
new Food(7, 4, false, false)
    ...
    .register();
new Food(1, 1, false, false, player => player.sendMessage("Фу"))
    ...
    .register();
new Food(1, 0.25, false, true, player => player.sendMessage("Фу"))
